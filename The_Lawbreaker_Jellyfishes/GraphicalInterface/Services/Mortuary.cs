...
namespace GraphicalInterface
{
    public partial class Mortuary : UserControl
    {
        ...
        public void ReloadList ()
        {
            ...
            {
                Label l = new Label();
                l.Font = new System.Drawing.Font(_ctrler.Font.Families[1], 18);
            ...
            for (int j = 0; j < m.BodyList.Count; j++)
            {
                ...
                get.Click += eh;
                get.Font = new System.Drawing.Font(_ctrler.Font.Families[1], 20);
                get.Text = "récupérer";
                get.AutoSize = true;
                ...
                name.Font = new System.Drawing.Font(_ctrler.Font.Families[1], 16);
                name.Name = "name";
            ...
            foreach (Character chara in t.Members)
            {
                if (!chara.isAlive)
                {
                    ...
                    stock.Click += eh;
                    stock.Font = new System.Drawing.Font(_ctrler.Font.Families[0], 20);
                    stock.Text = "déposer";
                    stock.AutoSize = true;
