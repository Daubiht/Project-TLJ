...
namespace LogicalGame.Test.Creation
{
    ...
    public class CreateSkills
    {
        ...
        public void We_can_add_a_skill_in_the_file_of_skill_and_recup_a_list_of_skill()
        {
            ...
            //Robustness
            Skill sr1 = new Skill("Position défensive", "Position dans laquelle la défense est plus efficace", new int[] { 0, 0, 0, -1, 0, 0 }, 0, 0, effect, new int[] { 0, 1 });
            Skill sr2 = new Skill("Protection", "Se jette devant un allier pour prendre les coups à sa place", new int[] { 0, 0, 0, 40, 0, 0 }, 1, 1, effect, new int[] { 0, 3 });
            sr2.PreviousSkill = sr1;
            Skill sr3 = new Skill("Bouclier Magique", "Englobe un allier d'un bouclier de pur energie", new int[] { 0, 0, 0, 40, 0, 0 }, 1, 1, effect, new int[] { 0, 2 });
            sr3.PreviousSkill = sr1;
            Skill sr4 = new Skill("Epine Magique", "Entoure un allier d'épine magique qui blesse les ennemies s'approchant de trop près", new int[] { 0, 0, 0, 50, 0, 0 }, 1, 1, effect, new int[] { 0, 4 });
            sr4.PreviousSkill = sr3;

            //Health
            Skill sh1 = new Skill("Vitalité", "Augmente le capital de santé", new int[] { 0, 0, 5, 0, 0, 0 }, 0, 0, effect, new int[] { 0, 0 });
            Skill sh2 = new Skill("Dépassement de soi", "Puise dans ses forces pour continuer à tenir debout", new int[] { 0, 0, 40, 0, 0, 0 }, 0, 0, effect, new int[] { 0, 10 });
            sh2.PreviousSkill = sh1;
            Skill sh3 = new Skill("Vitalité 2", "Augmente le capital de santé", new int[] { 0, 0, 15, 0, 0, 0 }, 0, 0, effect, new int[] { 0, 0 });
            sh3.PreviousSkill = sh1;
            Skill sh4 = new Skill("Vitalité 3", "Augmente le capital de santé", new int[] { 0, 0, 30, 0, 0, 0 }, 0, 0, effect, new int[] { 0, 0 });
            sh4.PreviousSkill = sh3;
            Skill sh5 = new Skill("Vitalité d'Ogre", "Augmente le capital de santé", new int[] { 0, 0, 55, 0, 0, 0 }, 0, 0, effect, new int[] { 0, 0 });
            sh5.PreviousSkill = sh4;
            Skill sh6 = new Skill("Vitalité de Titan", "Augmente le capital de santé", new int[] { 0, 0, 80, 0, 0, 0 }, 0, 0, effect, new int[] { 0, 0 });
            sh6.PreviousSkill = sh5;

            //Dodge
            Skill sd1 = new Skill("Instinct", "Augmente le capital d'esquive", new int[] { 0, 0, 0, 0, 0, 5 }, 0, 0, effect, new int[] { 0, 10 });
            Skill sd2 = new Skill("Anticipation", "Se concentre sur tout ce qui l'entoure et permet d'éviter une attaque", new int[] { 0, 0, 0, 0, 0, 50 }, 0, 0, effect, new int[] { 0, 3 });
            sd2.PreviousSkill = sd1;
            Skill sd3 = new Skill("Retour de bâton", "Permet de contre attaquer la prochaine attaque", new int[] { 0, 0, 0, 0, 0, 60 }, 0, 0, effect, new int[] { 0, 3 });
